...
export const Drawer = ({ setOpen }: any) => {
  ...
  return (
    <div className=" absolute right-0 top-0 z-[40] flex h-screen w-[70vw] flex-col justify-between bg-black px-8 pb-[6vh] pt-[10vh] font-gilroy text-lg sm:w-[50vw] sm:px-12 sm:text-2xl sm:font-semibold lg:w-[25vw]">
      <div className="flex w-full flex-col gap-y-[5vh]">
        <TopRightNav />
        <div className="flex flex-col gap-[3vh] text-left">
          <Link
            ...
            className="flex gap-3 py-2 sm:gap-6"
          >
      ...
      <div className=" flex w-full flex-col  gap-y-[2vh]">
        <span
          onClick={async () => {
        ...
        <span className="flex gap-3 py-2 sm:gap-6">
          <div className="flex w-12 items-center justify-center">
            <svg
              width="28"
              height="28"
...
const TopRightNav = () => {
  const { user } = useUser();
  return (
    <div className="justify-left flex w-full items-center gap-3 text-2xl sm:gap-6 sm:text-3xl">
