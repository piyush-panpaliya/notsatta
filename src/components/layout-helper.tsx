...
export const LayoutHelper = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className=" flex min-h-screen w-screen flex-col items-center gap-4 overflow-hidden pb-8 pl-8  pr-4 pt-4 sm:pl-12  sm:pr-6 sm:pt-10">
      {/* Header */}
